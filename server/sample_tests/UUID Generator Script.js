...
agent.gotoUrl("/screening/node_modules/montage/samples/uuid-generator/index.html");

agent.setWindowSize(927, 974);

//Gererate 4 UUIDs, verify all are unique
agent.element("/html/body/form/button").click(Mouse.LEFT,76,29);
agent.wait(1608);
agent.element("/html/body/form/button").click(Mouse.LEFT,76,28);
agent.wait(1728);
agent.element("/html/body/form/button").click(Mouse.LEFT,76,28);
agent.wait(1448);
agent.element("/html/body/form/button").click(Mouse.LEFT,76,28);
