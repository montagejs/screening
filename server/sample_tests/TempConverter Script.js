...
agent.gotoUrl("/screening/node_modules/montage/samples/temp-converter/index.html");

var celsius = agent.element("//*[@data-montage-id='celsius']");
var fahrenheit = agent.element("//*[@data-montage-id='fahrenheit']");
