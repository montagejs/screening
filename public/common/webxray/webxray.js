...
var buildMetadata = {"date": "Fri Nov 11 17:45:46 2011", "commit": "89252bbf70038f09c54aff444f4ec3cb97869bdb"};
...
jQuery.extend({
	...
	data: function( elem, name, data, pvt /* Internal Use Only */ ) {
		...
		if ( !id ) {
			...
			if ( isNode ) {
				elem[ jQuery.expando ] = id = ++jQuery.sequentialKey;
			} else {
				id = jQuery.expando;
			}
		}
  ...
  function MixMaster(options) {
    ...
    var self = {
      ...
      xpathForFocusedElement: function xpathForFocusedElement(options) {
        ...
        //alert(xpath);
        //alert(jQuery.webxraySettings.baseURI);
        jQuery.simpleModalDialog({
          input: options.input,
